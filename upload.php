...
// File upload path
$targetDir = "uploads/";
//Generate A random file name based on current time (considers micro seconds)
$file_name_iqama = round(microtime(true)). '.' .pathinfo($_FILES["image_iqama"]["name"],PATHINFO_EXTENSION);
...
$file_name_agreement = round(microtime(true))+1 . '.' .pathinfo($_FILES["image_agreement"]["name"],PATHINFO_EXTENSION);
